...
public class PaymentResource {
    ...
    //Adding PaymentService Functionality
    ...
    public ResponseEntity addNewCreditCardPost(
        ...
        return new ResponseEntity("PaymentService Added(Updated) Successfully!", HttpStatus.OK);
    }
    ...
    public ResponseEntity removePaymentPost(
        ...
        return new ResponseEntity("PaymentService remove sucessfully", HttpStatus.OK);
    }
